<template>
    ...
    <!-- bimtek pendamping UMKM -->
    <div class="container-lg kon-isi kon-mar-ed">
        <div class="row q-ma-md">
            <div class="text-h5 sec-title">Bimtek Pendamping UMKM</div>
        </div>
...
export default {
    ...
    setup () {
        ...
        const ambilPostingan = async () => {
            let response = await axios.get('api/bimtek_pendamping_umkm')
        ...
        const detailData = async (id) => {
            dialog.value = true
            let response = await axios.get('api/bimtek_pendamping_umkm/'+id)
