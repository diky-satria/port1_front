<template>
    ...
    <!-- pelatihan audit non academic -->
    <div class="container-lg kon-isi kon-mar-ed">
        <div class="row q-ma-md">
            <div class="text-h5 sec-title">Pelatihan Audit Non Akademik</div>
        </div>
    ...
    <!-- akhir pelatihan audit non academic -->
...
export default {
    ...
    setup () {
        ...
        const ambilPostingan = async () => {
            let response = await axios.get('api/pelatihan_audit_non_academic')
        ...
        const detailData = async (id) => {
            dialog.value = true
            let response = await axios.get('api/pelatihan_audit_non_academic/'+id)
